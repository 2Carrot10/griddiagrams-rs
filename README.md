# griddiagrams-rs
`griddiagrams-rs` is a significantly improved, rust-based implementation of [griddiagrams](https://github.com/paulitzlinger/griddiagrams) based on the findings of the [accompanying paper](https://arxiv.org/abs/2602.02642).
